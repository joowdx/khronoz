...
erDiagram
    ...
    WORKDAYS {
        ...
        smallint night "minutes inside 18:00-06:00"
...
CS Form 48 is certified by the employee and verified by the in-charge. Agencies add a department head or HR. Who signs, and in what order, is agency data, not schema.
