...
const sidebarMenuButtonVariants = cva(
    'peer/menu-button flex w-full items-center gap-2.5 overflow-hidden rounded-lg px-2.5 text-left text-[13px] leading-[18px] font-medium transition-[color,background-color,border-color] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-0! group-data-[collapsible=icon]:justify-center hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-45 aria-disabled:pointer-events-none aria-disabled:opacity-45 data-[active=true]:bg-acc-soft data-[active=true]:text-acc-text data-[active=true]:font-semibold data-[active=true]:[&>svg]:text-acc-text data-[state=open]:bg-sidebar-accent [&>span:last-child]:truncate [&>svg]:text-muted-foreground [&>svg]:size-4 [&>svg]:shrink-0',
    {
        variants: {
            variant: {
...
function SidebarMenuAction({
    ...
    return (
        <Comp
            ...
            className={cn(
                'text-sidebar-foreground peer-hover/menu-button:text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 transition-transform [&>svg]:size-4 [&>svg]:shrink-0',
                // Increases the hit area of the button on mobile.
                'after:absolute after:-inset-2 md:after:hidden',
