...
function DropdownMenuCheckboxItem({
    ...
    return (
        <DropdownMenuPrimitive.CheckboxItem
            ...
            className={cn(
                "focus:bg-row-hover relative flex h-8 cursor-default items-center gap-[9px] rounded-md pr-[9px] pl-8 text-[13px] leading-[18px] font-medium select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-45 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
                className,
            )}
            checked={checked}
            {...props}
...
function DropdownMenuSeparator({ className, ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.Separator>) {
    return (
        <DropdownMenuPrimitive.Separator
            ...
            className={cn('bg-border mx-1 my-[5px] h-px', className)}
            {...props}
        />
    );
}
...
function DropdownMenuSubTrigger({
    ...
    return (
        <DropdownMenuPrimitive.SubTrigger
            ...
            data-inset={inset}
            className={cn(
                "focus:bg-row-hover data-[state=open]:bg-row-hover [&_svg:not([class*='text-'])]:text-muted-foreground flex h-8 cursor-default items-center gap-[9px] rounded-md px-[9px] text-[13px] leading-[18px] font-medium select-none data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
                className,
            )}
            {...props}
        >
